...
public class UtilisateurAsserts {
    ...
    public static void assertUtilisateurUpdatableFieldsEquals(Utilisateur expected, Utilisateur actual) {
        assertThat(expected)
            ...
            .satisfies(e -> assertThat(e.getEmailPersonnel()).as("check emailPersonnel").isEqualTo(actual.getEmailPersonnel()));
    }
    ...
    public static void assertUtilisateurUpdatableRelationshipsEquals(Utilisateur expected, Utilisateur actual) {
        assertThat(expected)
            ...
            .satisfies(e ->
                assertThat(e.getEntreprisesDesirees()).as("check entreprisesDesirees").isEqualTo(actual.getEntreprisesDesirees())
            );
    }
}
